...
extern int list_insert(list_t **list, void *data, list_t **newest);
extern int list_add(list_t **list, void *data, list_t **newest);
extern int list_append(list_t **list, void *data, list_t **newest);
