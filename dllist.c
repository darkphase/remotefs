 ...
 *
 *   list_t **newest return pointer to new item if not
 *                   NULL
 *
 ...
 *   list_t *root;
 *   char   *data = "1";
 *   list_insert(&root, (const void*)data, NULL);
 *
 *************************************************************/

int list_insert(list_t **list, void *data, list_t **newest)
{
   list_t *prev = NULL;
   list_t *next = NULL;
   list_t *new;
 ...
 * Function: list_add()
 *
 * Add after the element pointed by **list a new list
 * element.
 ...
 *   list_t *root;
 *   char   *data = "1";
 *   list_add(&root, (const void*)data, NULL);
 *
 *************************************************************/

int list_add(list_t **list, void *data, list_t **newest)
{
   list_t *new;
 ...
 *   list_t *root;
 *   char   *data = "1";
 *   list_append(&root, (const void*)data, NULL);
 *
 *************************************************************/

int list_append(list_t **list, void *data, list_t **newest)
{
   list_t *prev;
   list_t *next;
   list_t *new;
